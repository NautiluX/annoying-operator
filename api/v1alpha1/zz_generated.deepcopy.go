...
func (in *Annoyance) DeepCopyInto(out *Annoyance) {
	*out = *in
...
func (in *Annoyance) DeepCopy() *Annoyance {
	if in == nil {
		return nil
	}
	out := new(Annoyance)
...
func (in *Annoyance) DeepCopyObject() runtime.Object {
...
func (in *AnnoyanceSpec) DeepCopyInto(out *AnnoyanceSpec) {
	*out = *in
	if in.Nuance != nil {
		in, out := &in.Nuance, &out.Nuance
		*out = make([]AnnoyanceNuance, len(*in))
		copy(*out, *in)
	}
}
